...
| WebSocket 到点推送 | 真推送 | 连接/心跳成本高 | 仍按 [后续待完成.md](d:\ProjectXX\设计文档\后续待完成.md) **M1-D33 → M6** |
...
- [M1核心循环设计.md](d:\ProjectXX\设计文档\M1核心循环设计.md) §修订：补充「体感实时 ≠ 全服定时写库」  
- [后续待完成.md](d:\ProjectXX\设计文档\后续待完成.md)：M1-D33 笔记补一句「片内进度条已消化体验诉求，真推送仍 M6」
