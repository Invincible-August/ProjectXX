...
权威细则：[`设计文档/开发计划.md`](../设计文档/开发计划.md) **§0.0～§0.9**。  
排期与延后项 **不要** 写进规则：读开发计划 **§20** 与 [`后续待完成.md`](../设计文档/后续待完成.md)。  
Cursor 如何加载本目录：[`Cursor约束配置说明.md`](../Cursor约束配置说明.md)。
...
| 场景 | 读 |
| --- | --- |
| 改后端 | [`rules/backend-conventions.mdc`](./rules/backend-conventions.mdc) |
| 改玩家前端展示 | [`rules/frontend-display.mdc`](./rules/frontend-display.mdc) |
| 改运营后台 / 新配置域 | [`rules/admin-ops.mdc`](./rules/admin-ops.mdc) · skill `admin-content-domain` |
| 新玩法竖切 | skill `vertical-slice` |
| 更新测试服 | skill `deploy-test-server` |
| 检定 / 随机 | [`骰子系统设计.md`](../设计文档/骰子系统设计.md) · 开发计划 §0.9 |
