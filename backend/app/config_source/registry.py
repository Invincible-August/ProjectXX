...
DOMAIN_REGISTRY: dict[str, DomainMeta] = {
    ...
    "divine_abilities": DomainMeta(
        domain_id="divine_abilities",
        filename="divine_abilities.yaml",
        title="神通",
        risk="content",
        description="神通目录与装备栏说明",
        category_id="content",
        category_title_zh="内容与设施",
        category_order=60,
    ),
    ...
    "talisman_effects": DomainMeta(
        domain_id="talisman_effects",
        filename="talisman_effects.yaml",
        title="符箓效果",
        risk="content",
        description="符箓效果白名单（自研只许引用）",
        category_id="craft",
    ...
    "equipment": DomainMeta(
        domain_id="equipment",
        filename="equipment.yaml",
        title="装备目录",
        risk="content",
        description="官方装备槽位、stats、挂机/骰子修正（M8 R1）",
        category_id="craft",
        category_title_zh="制造与装备",
        category_order=50,
    ),
    "research": DomainMeta(
        ...
        title="自研词条与门槛",
        risk="content",
        description="自研材料、功法词条稀有度/目录、重投次数、阵法门槛、符箓通道（M8）",
        category_id="craft",
        category_title_zh="制造与装备",
        category_order=50,
    ),
    ...
    "dao_lord": DomainMeta(
        ...
        title="道主",
        risk="balance",
        description="道主门槛/冷却/特权与赛会日程；后台入口已并入「道主控制台」",
        enabled=True,
        category_id="dao",
        category_title_zh="大道与道主",
        category_order=10,
